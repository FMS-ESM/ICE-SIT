...
!-----------------------------------------------------------------------
  call mpp_sync
  if (GDCHK) then
    print *, "Surface_boundary%t=",Surface_boundary%t
    print *, "I am in update_atmos_model_up 0.0: entering"
  endif
  ...
  if (GDCHK) then
    print *, "Surface_boundary%t=",Surface_boundary%t
      !! print *, "Atmos%Surf_diff=", Atmos%Surf_diff
      print *, "Surface_boundary%u_star=",Surface_boundary%u_star
      print *, "Surface_boundary%b_star=",Surface_boundary%b_star
      print *, "Surface_boundary%q_star=",Surface_boundary%q_star
    print *, "I am in update_atmos_model_up 0.1: atmosphere_up"
  endif
...
!   --- advance time ---
    ...
    if (GDCHK) then
      ...
      print *, "Atmos % t_bot=",Atmos % t_bot
      print *, "Atmos % tr_bot=",Atmos % tr_bot
      print *, "Atmos % p_bot=",Atmos % p_bot
      print *, "Atmos % z_bot=",Atmos % z_bot
      print *, "Atmos % p_surf=",Atmos % p_surf
      print *, "Atmos % slp=",Atmos % slp
      print *, "I am in update_atmos_model_up 1.0: get_bottom_mass"
    endif
    call mpp_sync
    ...
    call mpp_sync 
    if (GDCHK) then
      print *, "Atmos % u_bot=",Atmos % u_bot
      print *, "I am in update_atmos_model_up 2.0: get_bottom_wind"
    endif
