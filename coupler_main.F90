#ifdef program_coupler_main
#undef DEBUG
!!!#define DEBUG
!!!#define GDCHK0 .FALSE.
!!! #define GDCHK0 mpp_pe().EQ.449
...
!
  ...
  use ice_model_mod,           only: do_sit                    ! bjt
...
!
  ...
  use flux_exchange_mod,       only: flux_exchange_end                     ! bjt

  use atmos_tracer_driver_mod, only: atmos_tracer_driver_gather_data

  use mpp_mod,                 only: mpp_clock_id, mpp_clock_begin, mpp_clock_end, mpp_chksum, mpp_sync   ! bjt
...
!-----------------------------------------------------------------------
  ...
  character(len=128) :: version = '$Id: coupler_main.F90,v 20.0.2.1.2.1 2014/02/28 16:28:40 Seth.Underwood Exp $'
...
!#######################################################################
#ifdef DEBUG
  if (GDCHK0) print *, "I am in coupler_main 1.0: coupler_chksum, coupler_init"
#endif
...
#ifdef DEBUG
  if (GDCHK0) print *, "I am in coupler_main 2.0: flux_init_stocks"
#endif
...
#ifdef DEBUG
  if (GDCHK0) print *, "I am in coupler_main 2.1: mpp_set_current_pelist"
#endif
...
#ifdef DEBUG
  if (GDCHK0) print *, "I am in coupler_main 2.2: Ocean%is_ocean_pe, mpp_set_current_pelist."
#endif
...
newClock14 = mpp_clock_id( 'final flux_check_stocks' )
#ifdef DEBUG
  if (GDCHK0) print *, "I am in coupler_main 2.3: coupler_chksum"
#endif
  ...
  do nc = 1, num_cpld_calls
     ...
     if( Atm%pe )then
#ifdef DEBUG
        if (GDCHK0) print *, "I am in coupler_main 3.1: Atm%pe."
#endif
        call mpp_set_current_pelist(Atm%pelist)
...
#ifdef DEBUG
     if (GDCHK0) print *, "I am in coupler_main 3.2: mpp_set_current_pelist, atmos_ice_land_chksum, ocean_chksum."
#endif
     call mpp_set_current_pelist()
     if(do_chksum) then
       if (Atm%pe) then 
...
#ifdef DEBUG
     if (GDCHK0) print *, "I am in coupler_main 3.3: flux_ocean_to_ice."
#endif
...
#ifdef DEBUG
     if (GDCHK0) print *, "I am in coupler_main 3.4: atmos_ice_land_chksum, ocean_public_type_chksum."
#endif
...
#ifdef DEBUG
     if (GDCHK0) print *, "I am in coupler_main 3.5: flux_ice_to_ocean."
#endif
...
#ifdef DEBUG
     if (GDCHK0) print *, "I am in coupler_main 3.6: flux_check_stocks."
#endif
...
#ifdef DEBUG
     if (GDCHK0) print *, "I am in coupler_main 3.7."
#endif
     ...
     if( Atm%pe )then
...
#ifdef DEBUG
        if (GDCHK0) print *, "I am in coupler_main 4.1: update_ice_model_slow_up."
#endif
...
#ifdef DEBUG
        if (GDCHK0) print *, "I am in coupler_main 4.2: atmos_ice_land_chksum."
#endif
        ...
        call mpp_sync
#ifdef DEBUG
        if (GDCHK0) print *, "I am in coupler_main 4.3.: atmos/fast-land/fast-ice integration loop"
#endif
        ...
        do na = 1, num_atmos_calls
           ...
           call mpp_sync
#ifdef DEBUG
           if (GDCHK0) print *, "I am in coupler_main 4.3.1: atmos_ice_land_chksum"
#endif
!!! bjt >>
           if (do_sit) then
              call generate_sfc_xgrid( Land, Ice )
...
!!! << bjt
           ...
           call mpp_sync
#ifdef DEBUG
           if (GDCHK0) print *, "I am in coupler_main 4.3.2: atmos_tracer_driver_gather_data"
#endif
           ...
           call mpp_sync
#ifdef DEBUG
           if (GDCHK0) print *, "I am in coupler_main 4.3.3: sfc_boundary_layer"
#endif

           if (do_flux) then
              call mpp_clock_begin(newClockb)
              call sfc_boundary_layer( REAL(dt_atmos), Time_atmos, &                          ! allocate ( ex_albedo_vis_dir_fix(n_xgrid_sfc) )
           ...
           call mpp_sync
#ifdef DEBUG
           if (GDCHK0) print *, "I am in coupler_main 4.3.4: update_atmos_model_down"
#endif
           ...
           call mpp_sync
!!!#ifdef DEBUG
           if (GDCHK0) print *, "I am in coupler_main 4.3.5: flux_down_from_atmos."
!!!#endif

           call mpp_clock_begin(newClockd)
           call flux_down_from_atmos( Time_atmos, Atm, Land, Ice, &                   ! deallocate ( ex_albedo_vis_dir_fix )
           ...
           call mpp_sync
!!!#ifdef DEBUG
           if (GDCHK0) print *, "I am in coupler_main 4.3.6: update_land_model_fast."
!!!#endif
           ...
           call mpp_sync
!!!#ifdef DEBUG
           if (GDCHK0) print *, "I am in coupler_main 4.3.7: update_ice_model_fast."
!!!#endif
...
!!!#ifdef DEBUG
           if (GDCHK0) then
!!!             print *, "Ice%sitmask=",Ice%sitmask
!!!             print *, "Ice%t_surf=",Ice%t_surf
             print *, "I am in coupler_main 4.3.8: flux_up_to_atmos."
           endif
!!!#endif
...
!!!             print *, "Ice%sitmask=",Ice%sitmask
!!!             print *, "Ice%t_surf=",Ice%t_surf
!!!             print *, "Land_ice_atmos_boundary%t=",Land_ice_atmos_boundary%t             
             print *, "I am in coupler_main 4.3.9: atmos_ice_land_chksum."
           endif
!!!#endif
...
!!!#ifdef DEBUG
           if (GDCHK0) then
!!!             print *, "Land_ice_atmos_boundary%t=",Land_ice_atmos_boundary%t
             print *, "I am in coupler_main 4.3.10: update_atmos_model_up."
           endif
!!!#endif
...
!!!#ifdef DEBUG
           if (GDCHK0) then
!!!             print *, "Land_ice_atmos_boundary%t=",Land_ice_atmos_boundary%t
             print *, "I am in coupler_main 4.3.11: after atmos_ice_land_chksum."
           endif
!!!#endif
           !--------------
        enddo
        ...
        call mpp_sync
!!!#ifdef DEBUG
        if (GDCHK0) print *, "I am in coupler_main 5.1: update_land_model_slow."
!!!#endif
        ...
        call mpp_sync
#ifdef DEBUG
        if (GDCHK0) print *, "I am in coupler_main 5.2: flux_land_to_ice."
#endif
        ...
        call mpp_sync
#ifdef DEBUG
        if (GDCHK0) print *, "I am in coupler_main 5.3: slow-ice model."
#endif
        ...
        if (do_ice) then 
           ...
           call mpp_sync
#ifdef DEBUG
           if (GDCHK0) print *, "I am in coupler_main 5.3.1: update_ice_model_slow_dn."
#endif
...
#ifdef DEBUG
           if (GDCHK0) print *, "I am in coupler_main 5.3.2: atmos_ice_land_chksum"
#endif
...
#ifdef DEBUG
           if (GDCHK0) print *, "I am in coupler_main 5.3.3: flux_ice_to_ocean_stocks."
#endif
           ...
           call mpp_sync
#ifdef DEBUG
           if (GDCHK0) print *, "I am in coupler_main 5.3.4: atmos_ice_land_chksum."
#endif
     ...
     if( .NOT.use_lag_fluxes )then !this will serialize
        call mpp_sync
#ifdef DEBUG
        if (GDCHK0) print *, "I am in coupler_main 5.4: flux_ice_to_ocean."
#endif
        call mpp_set_current_pelist()
        call flux_ice_to_ocean( Time, Ice, Ocean, Ice_ocean_boundary )
     end if
     ...
     if( Ocean%is_ocean_pe )then
#ifdef DEBUG
        if (GDCHK0) print *, "I am in coupler_main 5.5: ocean_chksum, update_ocean_model."
#endif
...
#ifdef DEBUG
        if (GDCHK0) print *, "I am in coupler_main 6.0: increment_date."
#endif
...
#ifdef DEBUG
           if (GDCHK0) print *, "I am in coupler_main 6.1: atmos_model_restart, land_model_restart, ice_model_restart."
#endif
...
#ifdef DEBUG
           if (GDCHK0) print *, "I am in coupler_main 6.2: ocean_model_restart."
#endif
...
#ifdef DEBUG
        if (GDCHK0) print *, "I am in coupler_main 6.3: coupler_restart."
#endif
...
#ifdef DEBUG
     if (GDCHK0) print *, "I am in coupler_main 6.4: coupler_chksum."
#endif
...
#ifdef DEBUG
  if (GDCHK0) print *, "I am in coupler_main 7.0: flux_check_stocks."
#endif
...
#ifdef DEBUG
  if (GDCHK0) print *, "I am in coupler_main 7.1: coupler_end."
#endif
...
#ifdef DEBUG
  if (GDCHK0) print *, "I am in coupler_main 7.2: fms_end."
#endif

  call fms_end
#ifdef DEBUG
  if (GDCHK0) print *, "I am in coupler_main 8.: end."
#endif
...
#ifdef DEBUG
    if (GDCHK0) print *, "I am in coupler_init 1.0."
#endif
...
!----- read namelist -------
#ifdef DEBUG
    if (GDCHK0) print *, "I am in coupler_init 2.0."
#endif
...
#ifdef DEBUG
       if (GDCHK0) print *, "I am in coupler_init 3.0."
#endif    
...
#ifdef DEBUG
        if (GDCHK0) print *, "I am in coupler_init 3.1."
#endif
...
#ifdef DEBUG
        if (GDCHK0) print *, "I am in coupler_init 3.2."
#endif
...
!----- override calendar type with namelist value -----
...
#ifdef DEBUG
    if (GDCHK0) print *, "I am in coupler_init 3.3."
#endif
...
#ifdef DEBUG
    if (GDCHK0) print *, "I am in coupler_init 4.0."
#endif
    ...
    npes = ens_siz(2)              
#ifdef DEBUG
    if (GDCHK0) print *, "I am in coupler_init 5.0."
#endif
...
#ifdef DEBUG
    if (GDCHK0) print *, "I am in coupler_init 6.0."
#endif
...
!   !$OMP END PARALLEL
   ...
   !--- initialization clock
    ...
    if( Ocean%is_ocean_pe )then
!!!    if( Ocean%is_ocean_pe.AND.(.NOT.do_sit) )then
       call mpp_set_current_pelist(Ocean%pelist)
...
#ifdef DEBUG
    if (GDCHK0) print *, "I am in coupler_init 7.0."
#endif
...
#ifdef DEBUG
    if (GDCHK0) print *, "I am in coupler_init 7.1."
#endif
...
#ifdef DEBUG
        if (GDCHK0) print *, "I am in coupler_init 7.2."
#endif
...
#ifdef DEBUG
        if (GDCHK0) print *, "I am in coupler_init 7.2.1"
#endif

        call data_override_init(Atm_domain_in = Atm%domain)

#ifdef DEBUG
        if (GDCHK0) print *, "I am in coupler_init 7.2.2"
#endif
...
!---- land ----------
     if( Land%pe ) then
#ifdef DEBUG
        if (GDCHK0) print *, "I am in coupler_init 7.3.1"
#endif     
        call mpp_set_current_pelist(Land%pelist)
        if( mpp_pe().EQ.mpp_root_pe() ) then
          call DATE_AND_TIME(walldate, walltime, wallzone, wallvalues)
...
#ifdef DEBUG
        if (GDCHK0) print *, "I am in coupler_init 7.3.2"
#endif
...
#ifdef DEBUG
        if (GDCHK0) print *, "I am in coupler_init 7.3.3"
#endif
        if( mpp_pe().EQ.mpp_root_pe() ) then
          call DATE_AND_TIME(walldate, walltime, wallzone, wallvalues)
...
#ifdef DEBUG
        if (GDCHK0) print *, "I am in coupler_init 7.3.4"
#endif       
...
!---- ice -----------
     ...
     if( Ice%pe ) then
        ...
        call mpp_sync()
#ifdef DEBUG
        if (GDCHK0) print *, "I am in coupler_init 7.4.1"
#endif
        ...
        call mpp_sync()
#ifdef DEBUG
        if (GDCHK0) print *, "I am in coupler_init 7.4.2"
#endif
        ...
        call mpp_sync()
#ifdef DEBUG
        if (GDCHK0) print *, "I am in coupler_init 7.4.3"
#endif
        ...
        call mpp_sync()
#ifdef DEBUG
        if (GDCHK0) print *, "I am in coupler_init 7.4.4"
#endif
        ...
        call mpp_sync()
#ifdef DEBUG
        if (GDCHK0) print *, "I am in coupler_init 7.4.5"
#endif
...
!!!    if( Ocean%is_ocean_pe.AND.(.NOT.do_sit) )then
#ifdef DEBUG
        if (GDCHK0) print *, "I am in coupler_init 7.5.1"
#endif
...
!---- ocean ---------
...
#ifdef DEBUG
        if (GDCHK0) print *, "I am in coupler_init 7.5.2"
#endif
...
#ifdef DEBUG
        if (GDCHK0) print *, "I am in coupler_init 7.5.3"
#endif
...
#ifdef DEBUG
        if (GDCHK0) print *, "I am in coupler_init 7.5.4"
#endif
...
#ifdef DEBUG
    if (GDCHK0) print *, "I am in coupler_init 8."
#endif
    ...
    call mpp_set_current_pelist(ensemble_pelist(ensemble_id,:))
#ifdef DEBUG
    if (GDCHK0) print *, "I am in coupler_init 8.1"
#endif
    call mpp_broadcast_domain(Ice%domain)
#ifdef DEBUG
    if (GDCHK0) print *, "I am in coupler_init 8.2"
#endif
...
#ifdef DEBUG
    if (GDCHK0) print *, "I am in coupler_init 9."
#endif
...
#ifdef DEBUG
    if (GDCHK0) print *, "I am in coupler_init 10."
#endif
...
#ifdef DEBUG
    if (GDCHK0) print *, "I am in coupler_init 11."
#endif
...
#ifdef DEBUG
    if (GDCHK0) print *, "I am in coupler_init 12."
#endif
...
#ifdef DEBUG
    if (GDCHK0) print *, "I am in coupler_init 13."
#endif
...
!---- open and close dummy file in restart dir to check if dir exists --
    ...
    CALL diag_grid_end()
#ifdef DEBUG
    if (GDCHK0) print *, "I am in coupler_init 14.1"
#endif
...
#ifdef DEBUG
    if (GDCHK0) print *, "I am in coupler_init 14.2"
#endif
...
#ifdef DEBUG
    if (GDCHK0) print *, "I am in coupler_init 15"
#endif
...
!!!    if( Ocean%is_ocean_pe.AND.(.NOT.do_sit) )then
    ...
    ! bjt >>
    call flux_exchange_end ( atmos_ice_boundary, land_ice_atmos_boundary, &
         land_ice_boundary, ice_ocean_boundary, ocean_ice_boundary)
    !!! call mpp_set_current_pelist(ensemble_pelist(ensemble_id,:))
    ! << bjt
