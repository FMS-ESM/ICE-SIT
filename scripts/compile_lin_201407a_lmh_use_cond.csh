...
#################################################################
  ...
  set exename    = exec-lin_201407a_lmh_use_cond
  set executable = fms_tikal.x
  set cppDefs    = (-Duse_libMPI -Duse_netCDF  -DSPMD -DUSE_LOG_DIAG_FIELD_INFO  -Duse_LARGEFILE -DP_SPLIT -DUSE_COND -DHYDRO_DELZ_REMAP -DZERO_W_EXTRAP ) 
  set upDates    = 
