...
#  set sourceDir = /ncrc/home2/Benjei.Tsuang/tikal/update/v0.4/scripts/runs
  set sourceDir = /lustre/f1/Benjei.Tsuang/Aquaplanet
  # dir name:
  set dirName = runs/${expname}
  echo runs/${expname}
  # fast scratch:
  set fscratch = /lustre/f1/Benjei.Tsuang/Aquaplanet/${expname}
  # long-term scratch:
  set lscratch = /lustre/f1/unswept/Benjei.Tsuang/Aquaplanet/${expname}
  # gfdl archive:
  set gfdl_archive = /archive/Benjei.Tsuang/Aquaplanet/${expname}
########################################################################
